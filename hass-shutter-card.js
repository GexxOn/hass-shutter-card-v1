class ShutterCardV1 extends HTMLElement {
  set hass(hass) {
    const _this = this;
      ...
      style.textContent = `
        .sc-shutters { padding: 16px; }
          ...
          .sc-shutter-middle { display: flex; width: fit-content; max-width: 100%; margin: auto; }
            .sc-shutter-buttons { flex: 1; text-align: center; margin-top: 0.4rem; display: flex; max-width: 100%; transform: scale(0.75); }
            ...
            .sc-shutter-selector { flex: 1; }
              ...
              .sc-shutter-selector-picture { position: relative; margin: auto; background-size: 100% 100%; min-height: 150px; max-height: 100%; transform: scale(0.75); }
...
customElements.define("shutter-card-v1", ShutterCardV1);
